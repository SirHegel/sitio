import { pagina, persona } from "./plantilla.js";
...
<article class="ciencia" id="laboratorio-ciencia">
  <header class="ciencia-cabecera">
    ...
    <div class="ciencia-titular"><h1>La forma<br>de una <em>fase.</em></h1>
      <div class="ciencia-entrada"><span class="ciencia-sello">CUADERNO EXPERIMENTAL</span>
        <p>Dos estados pueden proyectar la misma sombra. Medir la población de los modos revela lo que la imagen esconde.</p>
  ...
  <section class="ciencia-cuaderno" aria-labelledby="cuaderno-titulo">
    <div class="ciencia-cuaderno-cabecera"><p class="ciencia-kicker">03 / El argumento, a la vista</p><h2 id="cuaderno-titulo">La cuenta tiene<br>que cerrar.</h2><p>Este estudio construye y verifica una solución exacta de un problema pequeño. No presenta una conjetura abierta como resuelta ni reclama novedad matemática.</p><button id="ciencia-descargar" type="button" disabled>↓ Descargar experimento · CSV</button><a href="/activos/modelo-ciencia.js" download>↓ Código del modelo · .js</a><a href="https://github.com/SirHegel/sitio" target="_blank" rel="noopener">Repositorio y pruebas ↗</a></div>
