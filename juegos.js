...
export const JUEGOS = [
  {
    ...
    tipo: descargaLista ? "Unreal Engine 5.5.4 · Alfa 0.2 para Linux" : "Unreal Engine 5.5.4 · Alfa en desarrollo",
    titulo: "La ciudad, a tu paso.",
    descripcion: "Recorre una interpretación de Neiva con un personaje sin nombre y un coche conducible. Cambia los colores de la ropa y camina entre árboles y bancos. El pequeño estudio ficticio de Jhon permite contactar sus servicios de desarrollo.",
    detalle: descargaLista ? "Alfa 0.2 disponible gratis para Linux x64. Mira la jugabilidad real y consulta los controles antes de empezar." : "Descarga Linux x64 en preparación. La alfa 0.2 sigue en desarrollo; las fachadas y muchas alturas son aproximadas.",
...
// Captura original aprobada del paquete Linux 0.2 descargado y ejecutado.
function vistaJuego(slug) {
  if (slug === "neiva-abierta") return `<figure class="juego-ilustracion juego-captura">
    <img src="/activos/neiva-unreal-linux.png" width="1920" height="1080" alt="Personaje junto a un coche rojo, árboles y edificios de la ciudad interpretada en Neiva Abierta" loading="lazy" decoding="async">
    <figcaption class="juego-arte-nota">Unreal / ${descargaLista ? 'Alfa 0.2 para Linux' : 'Alfa en desarrollo'}</figcaption>
  </figure>`;
...
export function indiceJuegos() {
  return pagina({
    ...
    descripcion: `${descargaLista ? 'Neiva Abierta, alfa 0.2 disponible para Linux con Unreal' : 'Neiva Abierta, alfa en desarrollo con Unreal para Linux'}, y Bloquitos para jugar gratis en el navegador. Vídeo, controles y alcance de cada juego.`,
    ...
    cuerpo: `    <section class="franja juegos-pagina" aria-labelledby="juegos-titulo">
      <div class="ancho">
        ...
        <aside class="juegos-nota revelar" aria-label="Sobre estos juegos">
          <div><p class="micro">Del mapa a la calle</p><p>La cartografía de Neiva procede de <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">OpenStreetMap y sus colaboradores</a> y <a href="https://docs.overturemaps.org/attribution/" target="_blank" rel="noopener">Overture Maps</a>. La ciudad es una aproximación: las fachadas, muchas alturas y parte del centro siguen interpretadas. Faltan interiores y detalles de barrios.</p><a class="mas" href="/proyectos/neiva-abierta/">Vídeo, controles y alcance <i aria-hidden="true">→</i></a></div>
          <div><p class="micro">Controles táctiles</p><p>Bloquitos admite botones y gestos en el celular. El <a href="https://neiva-abierta.vercel.app/" target="_blank" rel="noopener">prototipo web anterior de Neiva</a> conserva controles en pantalla. ${descargaLista ? 'La alfa 0.2 de Unreal se descarga para Linux' : 'La próxima alfa de Unreal está prevista para Linux'}; su vídeo se puede ver desde el teléfono.</p><a class="mas" href="mailto:${esc(PERSONA.email)}">Hablemos de tu proyecto <i aria-hidden="true">↗</i></a></div>
        </aside>
      </div>
    </section>`,
  });
